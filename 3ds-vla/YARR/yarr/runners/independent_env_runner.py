...
class IndependentEnvRunner(EnvRunner):
    ...
    def __init__(self,
            ...
            super().__init__(train_env, #agent, 
                            train_replay_buffer, num_train_envs, num_eval_envs,
                            rollout_episodes, eval_episodes, #training_iterations, 
                            eval_from_eps_number,
                            episode_length, eval_env, eval_replay_buffer, stat_accumulator,
                            rollout_generator, #weightsdir, 
                            logdir, max_fails, num_eval_runs,
    ...
    def start(self,# weight,
              ...
              device_idx,
              save_metrics,
              cinematic_recorder_cfg,eval_cfg):
        ...
        self._internal_env_runner = _IndependentEnvRunner(
            self._train_env, eval_env, #self._agent, 
            self._timesteps, self._train_envs,
            self._eval_envs, self._rollout_episodes, self._eval_episodes,
            #self._training_iterations, 
            self._eval_from_eps_number, self._episode_length, self._kill_signal,
